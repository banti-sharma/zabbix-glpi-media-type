var Helpdesk = {
    ...
    request: async function (method, query, data) {
    ...
    createIssue: async function () {
        ...
        var response = await Helpdesk.request('post', '/Ticket/', data);
    ...
    updateIssue: async function () {
        ...
        await Helpdesk.request('post', '/itilsolution/' + Helpdesk.params.helpdesk_ticket_id, data);
        await Helpdesk.killSession();
    },
    createOrUpdateTicket: async function (value) {
